...
def full_set_up(kaggle_json_path="C:/Users*Acer/.kaggle/kaggle.json", requirements_path="requirements.txt", dataset_name="ananthu017/emotion-detection-fer", dataset_dir="dataset"):
...
if __name__ == "__main__":
    ...
    full_set_up(kaggle_json_path="C:/Users/Acer/.kaggle/kaggle.json", #TODO: REPLACE WITH ACTUAL PATH
